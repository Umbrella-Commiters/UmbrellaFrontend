...
public class AppModule {
	...
	public static void bind(ServiceBinder binder) {
		...
		binder.bind(UserSession.class, UserSessionImpl.class);
	...
	public void contributeApplicationDefaults(MappedConfiguration<String, String> configuration) {
		...
		configuration.add(SymbolConstants.HMAC_PASSPHRASE,
				"f633b0f05bad309f1824f7f74995f5dbcaea951d5cd292600b543f33a7ed0548702575a5b8065ba6220e24cbdd9930024040292f4f1410c9955f908612898cb6");
	...
	public void contributeApplicationStateManager(MappedConfiguration<Class, ApplicationStateContribution> configuration) {
		ApplicationStateCreator<UserSession> creator = new ApplicationStateCreator<UserSession>() {
			public UserSession create() {
				return new UserSessionImpl();
			}
		};

		configuration.add(UserSession.class, new ApplicationStateContribution("session", creator));
	}
