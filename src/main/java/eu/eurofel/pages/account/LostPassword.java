...
public class LostPassword
{
    ...
    void onValidateFromLostPassword()
    {
        ...
        if ( acc != null && acc.getUid() != null && acc.getEmail() != null && !acc.getUid().equals( "" )
            && !acc.getEmail().equals( "" ) )
        {
            ...
            if ( service.addResetPwUUID( retriever.getUsername(), uuid ) )
            {
                ...
                // ",\n\nTo change your password please visit: <https://umbrellaid.org/euu/account/setnewpassword?uuid="
                // + uuid + ">\n\nYour Umbrella Team");
