...
public class EAAAccount
    implements Serializable, DirContext
{
    ...
    public EAAAccount( Attributes attributes )
    ...
    public DirContext getSchema( Name arg0 )
        throws NamingException
    {
    ...
    public DirContext getSchema( String arg0 )
        throws NamingException
    {
